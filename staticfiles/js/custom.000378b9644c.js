...
$(document).on('click', '.modal-swipe-prev, .modal-swipe-next', function(e){
    ...
    if (!e.target.classList.contains('disabled')) {
        ...
        if (e.target.classList.contains('modal-swipe-prev')) {
            $(this).closest('.slider-modal:first').css({'padding': '0', 'transform': 'translateX(-50%) translateY(-50%)', 'transition': 'transform 300ms cubic-bezier(0.25,0.46,0.45,0.94) 0s'});
            $(this).closest('.slider-modal').eq(1).css({'padding': '0', 'transform': 'translateX(200%) translateY(-50%)', 'transition': 'transform 300ms cubic-bezier(0.25,0.46,0.45,0.94) 0s'})
        }
        else {
            $(this).closest('.slider-modal').eq(1).css({'padding': '0', 'transform': 'translateX(-50%) translateY(-50%)', 'transition': 'transform 300ms cubic-bezier(0.25,0.46,0.45,0.94) 0s'});
            $(this).closest('.slider-modal:first').css({'padding': '0', 'transform': 'translateX(-200%) translateY(-50%)', 'transition': 'transform 300ms cubic-bezier(0.25,0.46,0.45,0.94) 0s'})
        }
    }
})
